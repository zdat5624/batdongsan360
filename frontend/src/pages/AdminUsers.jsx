...
const customStyles = `
  ...
  .modal-header {
    background: linear-gradient(135deg, #1a1a1a 0%, #2c3e50 100%); /* Màu mới */
    color: #fff;
  ...
  .modal-footer .btn-primary {
    background: linear-gradient(135deg, #1a1a1a 0%, #2c3e50 100%) !important; /* Màu mới */
    border: none !important;
  }
  .modal-footer .btn-primary:hover {
    background: linear-gradient(135deg, #0f0f0f 0%, #1f2a3c 100%) !important; /* Màu đậm hơn khi hover */
  }
  .action-button {
    border-radius: 20px;
    padding: 5px 10px;
