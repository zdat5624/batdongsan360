...
// Hàm chuyển đổi giá từ số sang chuỗi (triệu VNĐ/tháng hoặc tỷ VNĐ/tháng)
...
const customStyles = `
  ...
  .hover-card {
    ...
    max-width: 1000px; /* Thu nhỏ chiều rộng của card từ 1200px xuống 900px */
    height: 250px;
    margin: 0 auto;
  }
  .hover-card:hover {
...
const RentPage = ({ setLoading: setParentLoading }) => {
  ...
  return (
    <Container fluid className="py-5 rent-page-container">
